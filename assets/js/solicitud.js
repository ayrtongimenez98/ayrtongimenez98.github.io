...
function cargarFormulario(id) {
  ...
  headers1.append('GET', 'POST', 'OPTIONS');
        fetch(`https://tesoreriahbf.conveyor.cloud/api/Solicitud/${id}`, {
    //mode: 'no-cors',
    method: 'GET',
    headers: headers1
  })
  ...
  headers1.append('Access-Control-Allow-Origin', '*');
  headers1.append('GET', 'POST', 'OPTIONS');
  fetch(`https://tesoreriahbf.conveyor.cloud/api/Estado`, {
    //mode: 'no-cors',
    method: 'GET',
    headers: headers1
  })
...
if(estadoActual.esFinal == false) {
  ...
  headers1.append('Access-Control-Allow-Origin', '*');
  headers1.append('GET', 'POST', 'OPTIONS');
        fetch(`https://tesoreriahbf.conveyor.cloud/api/SolicitudEstado`, {
                //mode: 'no-cors',
                method: 'POST',
                headers: headers1,
...
headers1.append('Access-Control-Allow-Origin', '*');
headers1.append('GET', 'POST', 'OPTIONS');
    fetch(`https://tesoreriahbf.conveyor.cloud/api/observacion`, {
            //mode: 'no-cors',
            method: 'POST',
            headers: headers1,
            body: JSON.stringify(data)
